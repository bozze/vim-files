" =============================================================================
" Filename: autoload/lightline/colorscheme/my_solarized_light.vim
" Version: 0.0
" Author: bozze
" License: MIT License
...
let [s:black0, s:white1] = [s:white1, s:black0]
let [s:black1, s:white0] = [s:white0, s:black1]
let [s:gray0, s:gray3] = [s:gray3, s:gray0]
let [s:gray1, s:gray2] = [s:gray2, s:gray1]

let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}
let s:p.normal.left	= [ [ s:black1, s:white0 ], [ s:white0, s:gray0 ] ]
let s:p.normal.middle	= [ [ s:green, s:black1 ] ]
let s:p.normal.right	= [ [ s:black1, s:gray3 ], [ s:black1, s:gray1 ],  [ s:white0, s:black1 ] ]
let s:p.inactive.left	= [ [ s:gray1, s:black1 ], [ s:gray3, s:gray0 ] ]
let s:p.inactive.middle = [ [ s:gray2, s:black1 ] ]
let s:p.inactive.right	= [ [ s:gray2, s:black1 ] ]
let s:p.insert.left	= [ [ s:black0, s:white0 ], [ s:black0, s:blue ] ]
let s:p.replace.left	= [ [ s:white0, s:red ], [ s:white0, s:gray1 ] ]
let s:p.visual.left	= [ [ s:white0, s:magenta ], [ s:white0, s:gray1 ] ]
...
let g:lightline#colorscheme#my_solarized_light#palette = lightline#colorscheme#flatten(s:p)
